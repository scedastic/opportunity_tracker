...
from .views import (
    ...
    all_opportunities, open_opportunities, rejected_opportunities, opportunities_missing_contacts_follow_ups, 
    opportunity_view, recruiters, update_opportunity_stage,
    add_opportunity, abandoned_opportunities,
    all_contacts, contact_constantly, complete_contact_constantly,
    contact_view, add_follow_up_to_contact,
...
urlpatterns = [    
    ...
    path("rejected/", rejected_opportunities, name="rejected-opportunities"),
    ...
    path("contact-constantly/", contact_constantly, name="contact-constantly"),
    path("contact-constantly/<int:contact_id>/completed/", complete_contact_constantly, name="complete-contact-constantly"),
